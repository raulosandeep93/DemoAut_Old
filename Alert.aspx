                ...
                <div class="bs-example bs-example-tabs btn-group" role="tabpanel" data-example-id="togglable-tabs">
                    <ul class="nav nav-tabs nav-tabs-responsive" role="tablist">
                        <li class="responsive-menu">
                            <asp:Button runat="server" ID="btnAlert" CssClass="btn btn-primary menu-button Elements-Text" Text="Alert" OnClick="Alert_Click" /></li>
                        <li class="responsive-menu">
                            <asp:Button runat="server" ID="btnPrompt" CssClass="btn btn-primary menu-button Elements-Text" Text="Prompt" OnClick="Prompt_Click" /></li>
                        <li class="responsive-menu">
                            <asp:Button runat="server" ID="btnConfirmation" CssClass="btn btn-primary menu-button Elements-Text" Text="Confirmation" OnClick="Confirmation_Click" /></li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="row sub-menu-space">
                            <div class="col-xs-12 text-center">
                                <span style="color: palevioletred;">
                                    <input type="button" class="Elements-Text btn btn-danger" value="Alert" onclick="alertBox();" style="width: 200px; height: 100px; font-size: 30px; text-align: center" />
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row" style="margin-top: 30px;">
                            <div class="col-xs-12 text-left">
                                ...
                                <span class="Questions-Text">-Fetch the label and print it in the console.</span><br />
                            </div>
                        </div>
                    </div>
                </asp:View>
                    ...
                    <div class="container">
                        ...
                        <div class="row" style="margin-top: 30px;">
                            <div class="col-xs-12 text-left">
                                ...
                                <span class="Questions-Text">-Click on <span class="highlight">OK</span> button and <span class="highlight">Hard Assert</span> the message getting generated is having the text <span class="highlight">I was just joking i'm already having your BFF's number.</span></span><br />
                            </div>
                        </div>
                        ...
                        <div class="row row-space">
                            <div class="col-xs-12 text-left">
                                ...
                                <span class="Questions-Text">-Click on <span class="highlight">Confirmation</span>  button and fetch the text being displayed in the confirmation window.</span><br />
                                <span class="Questions-Text">-<span class="highlight">Soft Assert</span> whether the text being displayed is <span class="highlight">Can i have your BFF's number?</span></span><br />
                                <span class="Questions-Text">-Click on <span class="highlight">Cancel</span> button and <span class="highlight">Hard Assert</span> the message getting generated is having the text <span class="highlight">It's so sad that you don't want to share your BFF's number with me. :(</span></span><br />
                            </div>
                        </div>
                    </div>
                </asp:View>
